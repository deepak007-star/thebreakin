                  ...
                  {isScheduled ? (
                    ...
                    <>
                      ...
                      <p className="text-white/80 mb-6 flex-1">
                        ...
                        and create a personalized action plan to help you land your dream job in the US.
                      </p>
            ...
            <div className="flex flex-col md:flex-row items-center justify-between gap-6 p-6 bg-muted/50 rounded-2xl">
              ...
              <div className="flex flex-wrap items-center gap-2">
                {reasons.map((reason) => (
                  <span
                    key={reason}
                    className="inline-flex items-center gap-1.5 px-3 py-1.5 bg-background rounded-full text-sm"
                  >
