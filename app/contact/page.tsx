        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <a
              ...
              className="inline-flex items-center gap-2 px-4 py-2 bg-green-500/10 border border-green-500/30 rounded-full hover:bg-green-500/20 transition-colors"
            >
              ...
              <span className="font-medium text-green-500">+1 (916) 995-8113</span>
            </a>
          </motion.div>
        </div>
      </section>
